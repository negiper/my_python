...
def Help(obj,num=10):
    ...
    默认每次查看10行，可以通过参数num设定
    '''
    import sys,contextlib
    tmpfile_path = 'D:\\files\\my_python\\Tmp\\tmpfile_for_help'
...
__all__.extend(['Dir', 'ls','printf' ,'dir_tree','Help', 'get_screen_width'])
